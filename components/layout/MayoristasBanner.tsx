  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-5">
        <p className="font-mono text-[9px] tracking-[0.25em] uppercase text-red mb-3">
          ── ¿Comprás para revender?
        </p>
        <p className="font-heading text-[19px] font-medium leading-[1.2] text-paper mb-2 pr-4">
          Accedé a precios mayoristas.
        </p>
        <p className="font-body text-[12px] text-paper/55 leading-[1.6] mb-5">
